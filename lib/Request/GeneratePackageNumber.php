 ...
 */
class GeneratePackageNumber extends GeneratePackageNumbersRequest
{
    /**
     * @var Package[]
     */
    ...
    private function generateParcelsObject(array $parcels): array
    {
        ...
        foreach ($parcels as $parcel) {
            ...
            if ($parcel->getCustomerNotes() !== null && strlen($parcel->getCustomerNotes()) > 65) {
                [
                    $customerData1,
                    $customerData2,
                    $customerData3
                ...
                $parcelObject->setCustomerData1(empty($parcel->getCustomerNotes()) ? null : $parcel->getCustomerNotes());
            }
