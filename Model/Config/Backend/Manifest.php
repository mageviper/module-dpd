 ...
 * Class Manifest
 */
class Manifest extends \Magento\Framework\App\Config\Value
{
    const CRON_SCHEDULE_PATH = 'crontab/default/jobs/mageviper_dpd_manifest_cron/schedule/cron_expr';
    const CONFIG             = 'manifest_prepare';
    /**
     * @var ValueFactory
     */
    ...
    {
        $frequency = $this->getData('groups/mageviper_dpd/groups/dpd_cron/fields/frequency_manifest/value');
        $time      = $this->getData('groups/mageviper_dpd/groups/dpd_cron/fields/time_manifest/value');
